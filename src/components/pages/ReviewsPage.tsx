...
const REVIEWS: Review[] = [
  {
    ...
    date: "2 дня назад",
    rating: 5,
    text: "Меняли 80 000 ₴ на донги. Курс лучше, чем в обменниках. Менеджер отвечает быстро, встретились через 30 минут.",
    pair: "UAH → VND",
  },
  {
    id: "2",
    ...
    date: "5 дней назад",
    rating: 5,
    text: "Перевод на карту — деньги получила в банкомате Vietcombank через 15 минут. Всё чётко.",
    pair: "UAH → VND",
  },
  {
    id: "3",
    ...
    date: "1 нед. назад",
    rating: 4,
    text: "Поменял USDT на гривну. Комиссия адекватная, всё прозрачно. Единственное — пришлось подождать оператора 20 минут.",
    pair: "USDT → UAH",
  },
  {
    id: "4",
